...
// import { ArrowLeft, Maximize, Share2, Download, ShieldCheck, RefreshCw } from 'lucide-react'

// interface PageParams {
//   params: Promise<{ id: string }>;
// }

// export default function AnalyticsViewer({ params }: PageParams) {
//   // Unwrap the dynamic route parameters
//   const resolvedParams = use(params);
//   const reportId = resolvedParams.id;

//   // YOUR ACTUAL POWER BI URL
//   const powerBiUrl = "https://app.powerbi.com/view?r=eyJrIjoiM2EwNjcyYTEtMTk0Yy00MjIzLTk1NjMtZTI0YWI0MmY3NzM4IiwidCI6Ijk0ZGQwMWM2LWFhMTItNGMzNS1hODEyLWMxMDc5ZGUyOGQ2YSIsImMiOjl9";

//   return (
//     <div className="h-screen flex flex-col bg-white overflow-hidden">
//       {/* --- HEADER (IDH INSPIRED) --- */}
//       <header className="h-16 border-b border-zinc-200 flex items-center justify-between px-6 bg-white shrink-0 z-30 shadow-sm">
//         <div className="flex items-center gap-6">
//           <Link 
//             href="/research/barometer" 
//             className="flex items-center gap-2 text-zinc-500 hover:text-[#193C8D] transition-colors font-bold text-sm group"
//           >
...
//             <h1 className="font-black text-[#193C8D] text-xs uppercase tracking-[0.15em] leading-none mb-1">
//               Industrial Analytics Portal
//             </h1>
//             <p className="text-[10px] text-zinc-400 font-bold uppercase tracking-widest leading-none">
//               Viewing: <span className="text-[#E7B947]">{reportId.replace(/-/g, ' ')}</span>
//             </p>
//           </div>
//         </div>
...
//         {/* Action Tray */}
//         <div className="flex items-center gap-3">
//           <div className="hidden lg:flex items-center gap-2 mr-4 px-3 py-1.5 bg-blue-50 rounded-full border border-blue-100">
//             <ShieldCheck className="w-3.5 h-3.5 text-[#193C8D]" />
//             <span className="text-[10px] font-black text-[#193C8D] uppercase">Live Data Bank</span>
//           </div>

//           <button className="p-2.5 hover:bg-zinc-100 rounded-xl transition text-zinc-500" title="Share">
//             <Share2 className="w-4 h-4" />
//           </button>
          
//           <button className="p-2.5 hover:bg-zinc-100 rounded-xl transition text-zinc-500" title="Download Metadata">
//             <Download className="w-4 h-4" />
//           </button>

//           <button 
//             onClick={() => window.location.reload()}
//             className="flex items-center gap-2 px-5 py-2.5 bg-[#193C8D] text-white text-xs font-black uppercase tracking-widest rounded-xl hover:bg-[#142C55] transition-all shadow-lg active:scale-95"
//           >
...
//       {/* --- MAIN CONTENT (POWER BI) --- */}
//       <main className="flex-grow bg-[#F3F5F7] relative">
//         <div className="absolute inset-0 flex flex-col items-center justify-center pointer-events-none">
//             <div className="w-10 h-10 border-4 border-zinc-200 border-t-[#193C8D] rounded-full animate-spin mb-4" />
//             <p className="text-zinc-400 text-[10px] font-black uppercase tracking-[0.2em]">Loading Dashboard...</p>
//         </div>

//         <iframe 
//           title="KAM Industrial Barometer" 
...
//       {/* --- STATUS BAR --- */}
//       <footer className="h-8 bg-zinc-50 border-t border-zinc-200 flex items-center justify-between px-6 shrink-0">
//         <p className="text-[9px] font-bold text-zinc-400 uppercase tracking-widest">
//           Kenya Association of Manufacturers © 2026
//         </p>
//         <div className="flex items-center gap-4">
//             <span className="flex items-center gap-1.5 text-[9px] font-bold text-green-600 uppercase">
//                 <div className="w-1.5 h-1.5 rounded-full bg-green-500 animate-pulse" /> Encrypted Session
//             </span>
//         </div>
//       </footer>
//     </div>
